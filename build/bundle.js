...
"use strict";
var _bodyParser = __webpack_require__(28);var _bodyParser2 = _interopRequireDefault(_bodyParser);
var _parkingController = __webpack_require__(95);var _parkingController2 = _interopRequireDefault(_parkingController);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

var express = __webpack_require__(102);
var app = express();
...
app.get("/parkings", _parkingController2.default);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _parkingRepository = __webpack_require__(96);var _parkingRepository2 = _interopRequireDefault(_parkingRepository);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _asyncToGenerator(fn) {return function () {var gen = fn.apply(this, arguments);return new Promise(function (resolve, reject) {function step(key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {return Promise.resolve(value).then(function (value) {step("next", value);}, function (err) {step("throw", err);});}}return step("next");});};}

var getParkings = function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {var latitude, longitude, parkings;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            // get parameters
            ...
            _context.next = 5;return (0, _parkingRepository2.default)(latitude, longitude);case 5:parkings = _context.sent;

            // send parkings
            // res.send(mockParkings);
            res.send(parkings);case 7:case "end":return _context.stop();}}}, _callee, undefined);}));return function getParkings(_x, _x2) {return _ref.apply(this, arguments);};}();exports.default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _locationUtils = __webpack_require__(97);
var _gent = __webpack_require__(98);
var _openData = __webpack_require__(101);function _asyncToGenerator(fn) {return function () {var gen = fn.apply(this, arguments);return new Promise(function (resolve, reject) {function step(key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {return Promise.resolve(value).then(function (value) {step("next", value);}, function (err) {step("throw", err);});}}return step("next");});};}





var getParkingsForLocation = function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(latitude, longitude) {var dataSource;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            dataSource = findClosestDataSource(latitude, longitude);
            console.log("closest source", dataSource);_context.next = 4;return (
              dataSource.fetchParkings());case 4:return _context.abrupt("return", _context.sent);case 5:case "end":return _context.stop();}}}, _callee, undefined);}));return function getParkingsForLocation(_x, _x2) {return _ref.apply(this, arguments);};}();


var findClosestDataSource = function findClosestDataSource(latitude, longitude) {
  var closestSource = dataSources.
  map(function (source) {
    console.log(_locationUtils.distance);
    var distanceToSource = (0, _locationUtils.distance)(
    source.latitude,
    source.longitude,
    latitude,
    longitude,
...
var sortByDistance = function sortByDistance(a, b) {return a.distance - b.distance;};
...
var dataSources = [
{
  ...
  latitude: 51.05434,
  longitude: 3.717424,
  fetchParkings: _gent.fetchParkingsFromGhent },

{
  name: "Kortrijk",
  latitude: 50.827969,
  longitude: 3.26493,
  fetchParkings: _openData.fetchParkingsFromKortrijk },

{
  name: "Leuven",
  latitude: 50.879829,
  longitude: 4.70054,
  fetchParkings: _openData.fetchParkingsFromLeuven },

{
  name: "Sint-Niklaas",
  latitude: 51.164551,
  longitude: 4.13922,
  fetchParkings: _openData.fetchParkingsFromSintNiklaas }];exports.default =



getParkingsForLocation;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var distance = exports.distance = function distance(lat1, lon1, lat2, lon2, unit) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.fetchParkingsFromGhent = undefined;var _nodeFetch = __webpack_require__(99);var _nodeFetch2 = _interopRequireDefault(_nodeFetch);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _asyncToGenerator(fn) {return function () {var gen = fn.apply(this, arguments);return new Promise(function (resolve, reject) {function step(key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {return Promise.resolve(value).then(function (value) {step("next", value);}, function (err) {step("throw", err);});}}return step("next");});};}
...
var fetchRawData = function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {var response, json;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
              (0, _nodeFetch2.default)(
              "https://datatank.stad.gent/4/mobiliteit/bezettingparkingsrealtime.json"));case 2:response = _context2.sent;_context2.next = 5;return (

              response.json());case 5:json = _context2.sent;return _context2.abrupt("return",
            json);case 7:case "end":return _context2.stop();}}}, _callee2, undefined);}));return function fetchRawData() {return _ref2.apply(this, arguments);};}();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_url__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_url___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_url__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_https__ = __webpack_require__(100);
